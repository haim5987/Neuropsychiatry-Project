var jsPsychSurveyMultiChoice = (function (jspsych) {
  ...
  class SurveyMultiChoicePlugin {
      ...
      trial(display_element, trial) {
          ...
          html +=
              ".jspsych-survey-multi-choice-question { margin-top: 2em; margin-bottom: 2em; text-align: right; }" +
                //   ".jspsych-survey-multi-choice-text span.required {color: darkred;}" +
                  ".jspsych-survey-multi-choice-horizontal .jspsych-survey-multi-choice-text {  text-align: center;}" +
                  ".jspsych-survey-multi-choice-option { line-height: 2; }" +
                  ".jspsych-survey-multi-choice-horizontal .jspsych-survey-multi-choice-option {  display: inline-block;  margin-left: 1em;  margin-right: 1em;  vertical-align: top;}";
                  "label.jspsych-survey-multi-choice-text input[type='radio'] {text-align: right; margin-right: 1em;}";
          html += "</style>";
          // show preamble text
